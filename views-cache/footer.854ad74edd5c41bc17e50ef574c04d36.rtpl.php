<?php if(!class_exists('Rain\Tpl')){exit;}?>    <div class="footer-top-area">
    ...
    <!-- jQuery sticky menu -->
    <script src="/res/store/js/owl.carousel.min.js"></script>
    <script src="/res/store/js/jquery.sticky.js"></script>

    <!-- jQuery easing -->
    <script src="/res/store/js/jquery.easing.1.3.min.js"></script>

    <!-- Main Script -->
    <script src="/res/store/js/main.js"></script>

    <!-- Slider -->
    <script type="text/javascript" src="/res/store/js/bxslider.min.js"></script>
    <script type="text/javascript" src="/res/store/js/script.slider.js"></script>
</body>
